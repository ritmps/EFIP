...
ap.add_argument("-o", "--output", required=True, help="path to output directory to store images")
ap.add_argument("-i", "--id", type=int, help="id of aruco marker")
ap.add_argument("-t", "--type", help="type of aruco marker")
